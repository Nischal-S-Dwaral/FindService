...
export const getMoreDetailsComments = async (serviceRequestId) => {
    try {
        let config = {
            method: 'get',
...
export const getMoreDetailsSPComments = async (serviceProviderId) => {
    try {
        let config = {
            method: 'get',
            maxBodyLength: Infinity,
...
export const addMoreDetailsSPComment = async (data) => {
