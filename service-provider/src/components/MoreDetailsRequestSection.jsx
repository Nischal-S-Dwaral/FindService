...
import { addMoreDetailsSPRequest, getMoreDetailsSPRequest } from "../api/MoreDetailsRequest";
...
const MoreDetailsRequestSection = ({ properties }) => {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      const apiResponse = await getMoreDetailsSPRequest(serviceRequestId)
      if (apiResponse != null) {
  ...
  const handleSubmitButtonClick = async (event) => {
    ...
    async function fetchData() {
      const apiResponse = await addMoreDetailsSPRequest({
...
export default MoreDetailsRequestSection;
