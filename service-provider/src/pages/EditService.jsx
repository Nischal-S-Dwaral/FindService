                        ...
                        <Main>
                            ...
                            <Wrapper>
                                ...
                                <Form>
                                    ...
                                    <Label>Availability</Label> <Input type="text" defaultValue={service.availability}
                                                                       onChange={(e) => setServiceAvailability(e.target.value)}/>
                                    <Label>Price</Label> <Input type="text" defaultValue={service.price}
                                                                onChange={(e) => setServicePrice(e.target.value)}/>
                                    <Label>Location</Label> <Input type="text" defaultValue={service.location}
                                                                   onChange={(e) => setServiceLocations(e.target.value)}/>
                                    <div style={{display: 'flex', padding: '10px'}}>
                                        <Button onClick={handleSubmitButtonClick}>Save</Button>
                                        <Button onClick={() => navigate(`/service/${id}`)}>Cancel</Button>
                                    </div>
